...
static void InitColors(void)
{
    ...
    DefineColor("Light Green",0.75,1,0.75);
    DefineColor("Light Red",1,0.75,0.75);
    DefineColor("Light Blue",0.75,0.75,1);
    DefineColor("Mid Blue",0.5,0.5,1);
    DefineColor("Lightest Blue",0.9,0.9,1);
    DefineColor("Dark Yellow",0.85,0.85,0);
    DefineColor("Dark Green",0,0.5,0);
    DefineColor("Sky Blue",0.35,0.35,1);
    // Animation
    DefineColor("BlackToWhite1",0.1,0.1,0.1);
    DefineColor("BlackToWhite2",0.2,0.2,0.2);
    DefineColor("BlackToWhite3",0.3,0.3,0.3);
    DefineColor("BlackToWhite4",0.4,0.4,0.4);
    DefineColor("BlackToWhite5",0.5,0.5,0.5);
    DefineColor("BlackToWhite6",0.6,0.6,0.6);
    DefineColor("BlackToWhite7",0.7,0.7,0.7);
    DefineColor("BlackToWhite8",0.8,0.8,0.8);
    DefineColor("BlackToWhite9",0.9,0.9,0.9);
    //title
    DefineColor("Dark Green1",0,0.8,0);
    DefineColor("Dark Green2",0,0.7,0);
    DefineColor("Dark Green3",0,0.65,0);
    DefineColor("Dark Green4",0,0.6,0);
    DefineColor("Dark Green5",0,0.5,0);
    DefineColor("Brown1", .49, .28, .07);
    DefineColor("Brown2", .35, .20, .05);
    DefineColor("Brown3", .21, .12, .03);
}
